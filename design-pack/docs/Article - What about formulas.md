...
Key ideas section, third tile. Edit this file, then tell me to push it back into
the design.

**Excerpt** (shown on the tile): Where formulas are still the right choice, and where something else works better.

**End CTA button:** none - the article ends at the back link.

Notes: no heading on the intro, matching "Why Power Query?". Word dashes
converted to spaced hyphens, curly quotes to straight. Australian spelling.
