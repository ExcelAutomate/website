...
Key ideas section, second tile. Edit this file, then tell me to push it back
into the design.

**Excerpt** (shown on the tile): The tool we build most solutions around. Here's what it does, and how it could work for you.

**End CTA button:** none yet.

Notes: no heading on the intro, by choice. Word dashes converted to spaced
hyphens, curly quotes to straight. Australian spelling.
